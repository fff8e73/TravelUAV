...
def test_client_library():
    ...
    try:
        # 导入客户端
        from scripts.eval.HTTPTrajectoryClient_TravelUAV import HTTPTrajectoryClient
...
def main():
    ...
    print("  2. 服务端已启动: bash scripts/start_traveluav_server.sh")
